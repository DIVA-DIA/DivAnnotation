...
public class GUI extends JFrame {
    ...
    private JRadioButton zoneComment;
    private JRadioButton zoneTextSeg;
    private JRadioButton zoneCommentSeg;
    private JRadioButton zoneDecoration;
    private JRadioButton zoneWord;
    private JRadioButton zoneChar;
    private JCheckBox onlyPaintCurrentZoneType;
    ...
    public GUI() {
        ...
        zoneComment = new JRadioButton("comment");
        zoneCommentSeg = new JRadioButton("comment lines");
        zoneDecoration = new JRadioButton("decoration");
        zoneWord = new JRadioButton("word");
        zoneChar = new JRadioButton("character");
        onlyPaintCurrentZoneType = new JCheckBox("show exclusively", false);
        sharedBtns.add(save);
        ...
        zoneGroup.add(zoneComment);
        zoneGroup.add(zoneCommentSeg);
        zoneGroup.add(zoneDecoration);
        zoneGroup.add(zoneWord);
        zoneGroup.add(zoneChar);
        sharedBtns.add(zoneAll);
        sharedBtns.add(zoneText);
        sharedBtns.add(zoneTextSeg);
        sharedBtns.add(zoneComment);
        sharedBtns.add(zoneCommentSeg);
        sharedBtns.add(zoneDecoration);
        sharedBtns.add(zoneWord);
        sharedBtns.add(zoneChar);
        sharedBtns.add(onlyPaintCurrentZoneType);

        this.add(content);
        //this.add(sharedBtns);

        tabbedPane.addTab("Open", new OpenMenu(this));
        tabbedPane.addTab("Parts management", new Parts(this));
        ...
        tabbedPane.addTab("Area Creation", new AreaCreationPanel(this));
        //tabbedPane.addTab("Text-lines Extraction", new LinesSegPanel(this));
...
//        unlockTabs(1);
        ...
        zoneComment.addActionListener(GUI.this::zoneCommentClicked);
        zoneCommentSeg.addActionListener(GUI.this::zoneCommentSegClicked);
        zoneDecoration.addActionListener(GUI.this::zoneDecorationClicked);
        zoneWord.addActionListener(GUI.this::zoneWordClicked);
        zoneChar.addActionListener(GUI.this::zoneCharClicked);
        onlyPaintCurrentZoneType.addActionListener(GUI.this::onlyPaintCurrentZoneTypeClicked);
    ...
    private void onlyPaintCurrentZoneTypeClicked(ActionEvent evt) {
        if (tabbedPane.getSelectedComponent() instanceof TeiScrollableImagePanel) {
            TeiScrollableImagePanel panel = (TeiScrollableImagePanel) tabbedPane.getSelectedComponent();
            panel.setOnlyPaintCurrentZoneType(onlyPaintCurrentZoneType.isSelected());
        }
    }
    ...
    public void unlockTabs(int nb) {
        ...
        for (int i = nb; i < tabbedPane.getComponentCount(); i++) {
            tabbedPane.setEnabledAt(i, false);
        }
    }
    ...
    public final void updateSharedPanelItems() {
        if (tabbedPane.getSelectedComponent() instanceof TeiScrollableImagePanel) {
            ...
            zoneWord.setVisible(true);
            zoneChar.setVisible(true);
            zoneDecoration.setVisible(true);
            zoneComment.setVisible(true);
            zoneCommentSeg.setVisible(true);
            onlyPaintCurrentZoneType.setVisible(true);
            ...
            if (panel.getSelectableZoneTypes().contains(TeiScrollableImagePanel.ZONE_TYPES.COMMENT_ZONE)) {
                zoneComment.setEnabled(true);
            } else {
                zoneComment.setEnabled(false);
            }
            if (panel.getSelectableZoneTypes().contains(TeiScrollableImagePanel.ZONE_TYPES.COMMENTSEG_ZONE)) {
                zoneCommentSeg.setEnabled(true);
            } else {
                zoneCommentSeg.setEnabled(false);
            }
            if (panel.getSelectableZoneTypes().contains(TeiScrollableImagePanel.ZONE_TYPES.DECO_ZONE)) {
                zoneDecoration.setEnabled(true);
            } else {
                zoneDecoration.setEnabled(false);
            }
            if (panel.getSelectableZoneTypes().contains(TeiScrollableImagePanel.ZONE_TYPES.WORD_ZONE)) {
                zoneWord.setEnabled(true);
            } else {
                zoneWord.setEnabled(false);
            }
            if (panel.getSelectableZoneTypes().contains(TeiScrollableImagePanel.ZONE_TYPES.CHAR_ZONE)) {
                zoneChar.setEnabled(true);
            } else {
                zoneChar.setEnabled(false);
            }
            if (null != panel.getCurrentZoneType()) {
                switch (panel.getCurrentZoneType()) {
                    ...
                    case TEXTSEG_ZONE:
                        ...
                        break;
                    case COMMENT_ZONE:
                        zoneComment.setSelected(true);
                        break;
                    case COMMENTSEG_ZONE:
                        zoneCommentSeg.setSelected(true);
                        break;
                    case DECO_ZONE:
                        zoneDecoration.setSelected(true);
                        break;
                    case WORD_ZONE:
                        zoneWord.setSelected(true);
                        break;
                    case CHAR_ZONE:
                        zoneChar.setSelected(true);
                        break;
                    default:
                        break;
                }
            ...
            zoneComment.setVisible(false);
            zoneCommentSeg.setVisible(false);
            zoneWord.setVisible(false);
            zoneChar.setVisible(false);
            zoneDecoration.setVisible(false);
            onlyPaintCurrentZoneType.setVisible(false);
        }
